...
(function() {
    ...
    var form_16_to_submit = document.getElementById('_form_16_');
    var form_14_to_submit = document.getElementById('_form_14_');
    var form_12_to_submit = document.getElementById('_form_12_');

    var allInputs_16 = null;
    var allInputs_14 = null;
    var allInputs_12 = null;

    if (form_16_to_submit) {
        allInputs_16 = form_16_to_submit.querySelectorAll('input, select, textarea');
    }

    if (form_14_to_submit) {
        allInputs_14 = form_14_to_submit.querySelectorAll('input, select, textarea');
    }
